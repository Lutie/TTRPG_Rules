    ...
    <div id="tab-principal" className="tab-content active">
      ...
      <Section title="Caractéristiques">
        <div className="caracteristiques-grid">
          ...
          <CaracBox name="Attrition Physique" value={formatMod(calc.attrNatPhys)} help="mFOR" />
          <CaracBox name="Attrition Mentale" value={formatMod(calc.attrNatMent)} help="mCHA" />
          <CaracBox name="Aggravation Physique" value={formatMod(calc.aggravPhys)} help="mDEX" />
          <CaracBox name="Aggravation Mentale" value={formatMod(calc.aggravMent)} help="mINT" />
          <CaracBox name="Précision Physique" value={formatMod(calc.precPhys)} help="mPER (mêlée)" />
          ...
          <p className="carac-note">Ces valeurs représentent les caractéristiques naturelles du personnage et n'incluent pas l'impact des équipements.</p>
        </div>
      </Section>
