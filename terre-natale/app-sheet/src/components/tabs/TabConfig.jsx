...
const BONUS_GROUPS = [
  ...
  },
  {
    groupe: 'Combat',
    types: [
      { id: 'protectionPhysique', nom: 'Protection Physique' },
      ...
      { id: 'moral', nom: 'Moral' },
      { id: 'perfPhysique', nom: 'Perforation Physique' },
      { id: 'perfMentale', nom: 'Perforation Mentale' },
      { id: 'attritionPhysique', nom: 'Attrition Physique' },
      { id: 'attritionMentale', nom: 'Attrition Mentale' },
      { id: 'aggravationPhysique', nom: 'Aggravation Physique' },
      { id: 'aggravationMentale', nom: 'Aggravation Mentale' },
