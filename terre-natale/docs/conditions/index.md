...
(function() {
  ...
  },
  {
    ...
    "domaine_b": "⚖️ Loi",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage est voit sa résistance aux énergies (feu, foudre, froid) augmentées de un (deux) cran(s)"
  },
  {
    "nom": "Fièvre",
    "polarite": "negative",
    ...
    "domaine_b": "🌀 Chaos",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage est voit sa résistance aux énergies (feu, foudre, froid) réduite de un (deux) cran(s)"
  },
  {
    "nom": "Fraicheur",
    "polarite": "positive",
    ...
    "domaine_b": "⚖️ Loi",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage est voit sa résistance aux matières (eau, air, terre) augmentées de un (deux) cran(s)"
  },
  {
    "nom": "Frisson",
    "polarite": "negative",
    ...
    "domaine_b": "🌀 Chaos",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage est voit sa résistance aux matières (eau, air, terre) réduite de un (deux) cran(s)"
  },
  {
    "nom": "Isolé",
    "polarite": "positive",
    ...
    "domaine_b": "⚖️ Loi",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage est voit sa résistance aux dégats de zone augmentées de un (deux) cran(s)"
  },
  {
    "nom": "Magnétique",
    "polarite": "negative",
    ...
    "domaine_b": "🌀 Chaos",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage est voit sa résistance aux dégats de zone réduite de un (deux) cran(s)"
  },
  {
    "nom": "Bénit",
    "polarite": "positive",
  ...
  },
  {
    ...
    "domaine_b": "🌀 Chaos",
    "sauvegarde": "Détermination",
    "effet": "Le personnage est voit sa résistance à la lumière, la loi, le sacré et la vie d'un (deux) cran"
  },
  {
    "nom": "Profané",
    "polarite": "positive",
  ...
  },
  {
    ...
    "domaine_b": "🌀 Chaos",
    "sauvegarde": "Détermination",
    "effet": "Le personnage est voit sa résistance à l'ombre, le chaos, l'impie et la mort d'un (deux) cran"
  },
  {
    "nom": "Stoïque",
    "polarite": "positive",
  ...
  },
  {
    ...
    "domaine_b": "👁️ Vision",
    "sauvegarde": "Détermination",
    "effet": "Le personnage est habitué à tous les types d'action (il peux également réaliser les actions complexes en actions simples), de plus il reçoit un bonus de technicité de 2 (3)"
  },
  {
    "nom": "Furie",
    "polarite": "negative",
  ...
  },
  {
    ...
    "domaine_b": "🪨 Terre",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage reçoit un (deux) avantage à ses tests de défense et de robustesse tant qu’il reste immobile ou ne se déplace pas ou ne s'est pas déplacé ce round ci"
  },
  {
    "nom": "Entrelacé",
    "polarite": "negative",
    ...
    "domaine_b": "🪨 Terre",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage reçoit un (deux) désavantage à ses tests de combat et de réflexe tant qu’il reste immobile ou ne se déplace pas ou ne s'est pas déplacé ce round ci"
  },
  {
    "nom": "Verdoyant",
    "polarite": "positive",
    ...
    "domaine_b": "❤️ Vie",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage reçoit un (deux) savantage à tous ses tests de sauvegarde contre les poisons, maladies et effets de toxines/poisons/etc. Les HOT qu’il reçoit (PV, PE, etc.) sont augmentés de 1D6 (+2), les DOT (ruptures) réduit d'autant."
  },
  {
    "nom": "Flétrissement",
    "polarite": "negative",
    ...
    "domaine_b": "☠️ Mort",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage reçoit un (deux) désavantage à tous ses tests de sauvegarde contre les poisons, maladies et effets de toxines/poisons/etc. Les DOT (ruptures) qu’il reçoit (PV, PE, etc.) sont augmentés de 1D6 (+2), les HOT réduit d'autant."
  },
  {
    "nom": "Bourgeonnement",
    "polarite": "positive",
    ...
    "domaine_b": "❤️ Vie",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage reçoit, au début de chaque tours, des soins équivalants au double (triple) de sa pénalité de blessure directement sur l'endurance (PE) puis la vitalité (PV) si endurance pleine."
  },
  {
    "nom": "Décomposition",
    "polarite": "negative",
    ...
    "domaine_b": "☠️ Mort",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage subit, au début de chaque tours, des dégats de rupture équivalants au double (triple) de sa pénalité de blessure directement sur l'endurance (PE) puis la vitalité (PV) si choqué."
  },
  {
    "nom": "Euphorie",
    "polarite": "positive",
    ...
    "domaine_b": "🌀 Chaos",
    "sauvegarde": "Détermination",
    "effet": "Le personnage reçoit un bonus à ses tests de +1 pour chaque 2 PS qu'il accepte de perdre, maximum 2 (3)"
  },
  {
    "nom": "Panique",
    "polarite": "negative",
    ...
    "domaine_b": "🌀 Chaos",
    "sauvegarde": "Détermination",
    "effet": "Le personnage reçoit un malus de 2 (3) à ses tests et peux réduire ces derniers de 2 pour chaque PS qu'il accepte de perdre"
  },
  {
    "nom": "Stase",
    "polarite": "positive",
    ...
    "domaine_b": "☀️ Lumière",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage voit les pénalités des lésions réduites de 1 (2), la protection (physique ou mentale) du personnage augmente de 2 (3), les pertes d'endurances sont réduites de 2 (3)"
  },
  {
    "nom": "Hypothermie",
    "polarite": "negative",
    ...
    "domaine_b": "🌑 Ombre",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage voit les pénalités des lésions augmentés de 1 (2), la protection (physique ou mentale) du personnage est réduite de 2 (3), les pertes d'endurances sont augmentées de 2 (3)"
  },
  {
    ...
    "domaine_b": "⚡ Foudre",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage n'a pas besoin de respirer, de plus il reçoit 2 (3) PE temporaires au début de chaque round"
  },
  {
    "nom": "Suffocation",
    "polarite": "negative",
    ...
    "domaine_b": "❄️ Glace",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage est considéré comme incapable de respirer (et donc sujet aux règles de suffocation), de plus il perd 2 (3) PE temporaires au début de chaque round"
  },
  {
    "nom": "Hydratation",
    "polarite": "positive",
    ...
    "domaine_b": "🪷 Nature",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage double, au début de chaque tours, toutes ses ressources temporaires avec un maximum de gain de D8 (+2)."
  },
  {
    "nom": "Déshydraté",
    "polarite": "negative",
    ...
    "domaine_b": "🪷 Nature",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage subit, au début de chaque tours, une perte de toutes ses ressources temporaires de D8 (+2)."
  },
  {
    "nom": "Auréole",
    "polarite": "positive",
    ...
    "domaine_b": "❤️ Vie",
    "sauvegarde": "",
    "effet": "Le personnage survie à sa prochaine mort si celle ci est lié à une seule (toute) raison (exemple : PV trop bas, lésion trop grave, ect), ce qui met fin à la condition le cas échéant"
  },
  {
    "nom": "Agonie",
    "polarite": "negative",
    ...
    "domaine_b": "☠️ Mort",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage subit, au début de chaque tours, des dégats de rupture équivalants à 2D8 (+4) directement sur l'endurance (PE) puis la spiritualité (PS) si choqué, les dégats sont modifiés par le résultat d'un test de sauvegarde de détermination."
  },
  {
    "nom": "Caustique",
    "polarite": "negative",
    ...
    "domaine_b": "☢️ Toxique",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage subit, au début de chaque tours, des dégats de rupture équivalants à 2D8 (+4) directement sur l'endurance (PE) puis la vitalité (PS) si choqué, les dégats sont modifiés par le résultat d'un test de sauvegarde de robustesse."
  },
  {
    "nom": "Givre",
    "polarite": "negative",
    ...
    "domaine_b": "",
    "sauvegarde": "Robustesse",
    "effet": "Le personnage doit effectuer un test de robustesse au début de chaque rounds, si il rate ce test il perd une action simple, sur un échec critique il perd les deux"
  },
  {
    "nom": "Venin",
    "polarite": "negative",
