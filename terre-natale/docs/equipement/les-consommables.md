...
<img src="images/image14.png" style="width:300px; flex-shrink:0;">
<div>
<p>Les potions sont des breuvages distillés via l’usage de la magie et contenant des sorts.</p>
<p><strong>Nature.</strong> Magie.</p>
<p><strong>Création.</strong> Test combiné de Modus (Groupe Arcane) et Magie (Groupe Artisanat) et Domaine (Groupe Magie).</p>
<p><strong>Usage.</strong> Se consomme.</p>
<p><strong>Effet de la qualité.</strong> Augmente le niveau de l’effet (qui est donc de 0 + Qualité).</p>
<p><strong>Encombrement.</strong> ½ (par potions)</p>
<p><strong>Prix de base – Elixir.</strong> 14 🪙</p>
<p><strong>Prix de base – Infusion.</strong> 12 🪙</p>
<p><strong>Prix de base – Breuvage.</strong> 20 🪙</p>
<p><strong>Prix de base – Philtre.</strong> 18 🪙</p>
<p><strong>Prix de base – Essence.</strong> 16 🪙</p>
</div>
</div>

**Description.** Consommer la potion permet d’en déclencher les effets. Il existe cependant plusieurs catégories de potion :

- **Elixir** : Effets immédiats positifs (école : restauration).
- **Infusion** : Effets immédiats négatifs (école : destruction).
- **Breuvage** : Effets d’enchantement positif (école : bénédiction).
- **Philtre** : Effets d’enchantement négatif (école : malédiction).
- **Essence** : Effet d’enchantement neutre (école : Conjuration).

Les potions contiennent des sorts simples constitués d’un unique mot d’effet, il existe ainsi autant de potions différentes que de mots ! Mais il y a évidemment certains classiques (tel que l’élixir de vie soignant la vitalité) plus répandus que d’autres. Toutes les potions faisant effet sur une cible génèrent automatiquement 2 de corruption (temporaire, nettoyé lors d’un repos). Il ne peut y avoir plus d’une potion de même nature (enchantement positif ou négatif) active à la fois, la dernière ou plus puissante est conservée ; les effets d’enchantement ne peuvent être maintenus, la décharge est automatique et inéluctable. Qu’elle soit utilisée au contact ou à distance sur un tiers, la potion nécessite un test adapté (respectivement combat sans arme ou jet) pour toucher sa cible. Les potions bénéfiques peuvent toujours être appliquées si la cible abaisse sa défense passive. Les potions ne peuvent pas être critiques.

> **Notes :** Le niveau des effets est équivalent à la qualité. La potion ne bénéficie pas du modificateur d’attribut d’un lanceur de sort ni d’un focalisateur. Une potion peut se briser lors d’une chute ou événement similaire (test de solidité DD 10).
...
<div style="display:flex; gap:1.5em; align-items:flex-start; margin-bottom:1.5em;">
<img src="images/image18.jpg" style="width:300px; flex-shrink:0;">
<div>
<p>Les parchemins permettent aux mages de lancer des sorts qu’ils ne connaissent pas ou d’accroître la puissance de ceux qu’ils connaissent.</p>
<p><strong>Nature.</strong> Magie.</p>
<p><strong>Création.</strong> Test combiné de Erudis (Groupe Arcane) et Écriture (Groupe Érudition) et Domaine (Groupe Magie).</p>
<p><strong>Usage (utilisation).</strong> Arme focale (Arcanes) ou Domaine/Ecole (Magie).</p>
<p><strong>Effet de la qualité.</strong> Augmente le niveau maximum du sort (qui est donc de 0 + Qualité).</p>
<p><strong>Encombrement.</strong> ½ (par parchemins)</p>
<p><strong>Prix de base – Effet immédiat positif.</strong> 14 🪙</p>
<p><strong>Prix de base – Effets immédiats négatifs.</strong> 12 🪙</p>
<p><strong>Prix de base – Effets d’enchantement positif.</strong> 20 🪙</p>
<p><strong>Prix de base – Effets d’enchantement négatif.</strong> 18 🪙</p>
<p><strong>Prix de base – Effet d’enchantement neutre.</strong> 16 🪙</p>
<p><strong>Prix de base – Effet d’enchantement d’invocation.</strong> 24 🪙</p>
<p><strong>Prix de base – Effet autres.</strong> 22 🪙</p>
</div>
</div>

**Description.** Un parchemin peut être utilisé (et consommé) pour lancer le sort inscrit dessus (au niveau où il est inscrit ou inférieur, mais pas plus haut). Le personnage peut soit :

- Effectuer un test d’Arme focale (Groupe Arcane).
- Effectuer un test du domaine ou de l’école associé au sort inscrit (Groupe Magie) afin de bénéficier d’être avantagé à son test. Cet avantage s’applique aussi au jet si le personnage connaît le sort.

Si le sort est lancé à un niveau inférieur à celui qui est inscrit, alors l’utilisateur reçoit un bonus de +2 à ses tests par niveaux manquants.
...
<div style="display:flex; gap:1.5em; align-items:flex-start; margin-bottom:1.5em;">
<img src="images/image19.jpg" style="width:300px; flex-shrink:0;">
<div>
<p>Les poisons sont des substances, souvent distillées à partir de venins et autres toxines, qui ont pour but d’affaiblir ou tuer une créature intoxiquée.</p>
<p><strong>Nature.</strong> Antique.</p>
<p><strong>Création.</strong> Test de travail des poisons (Artisanat).</p>
<p><strong>Usage (application).</strong> Test de travail du poison (DEX) ou bricolage.</p>
<p><strong>Effet de la qualité.</strong> Augmente la catégorie du poison (qui est de 0 + qualité).</p>
<p><strong>Encombrement.</strong> ½ (par doses)</p>
</div>
</div>

**Description.** Un poison peut être utilisé (et consommé) de deux façons différentes :

- **En induisant une arme** (nécessairement tranchante ou perforante) afin d’inoculer ce dernier par lésion. La condition associée est appliquée lorsqu’une cible est blessée par l’arme (perte d’au moins un point de vitalité) et qu’elle rate son test de sauvegarde (Robustesse). Pour appliquer le poison sur une arme, un test de travail du poison (DEX) ou bricolage est nécessaire contre une difficulté d’évaluation (5) ; l’arme est dotée de 1 charge par marge de réussite et l’effet dure le temps d’une scène. En cas d’échec la dose est perdue ; en cas d’échec critique, le personnage subit lui-même les effets du poison.
- **En faisant directement absorber une dose** à la cible (de force ou par astuce), qui est alors désavantagée à son test de sauvegarde.

Dans les deux cas les charges de la condition associée au poison dépendent d’un jet basé sur la catégorie de celui-ci (pas besoin de relancer le jet d’une attaque qui aurait inoculé le poison, il faut utiliser le jet de l’attaque et ajouter des dés si nécessaire). Plus le poison est difficile à manipuler et plus il est efficace. La difficulté associée à la condition est liée à l’expertise physique du personnage, mais la qualité du poison est appliquée.
...
<div style="display:flex; gap:1.5em; align-items:flex-start; margin-bottom:1.5em;">
<img src="images/image17.jpg" style="width:300px; flex-shrink:0;">
<div>
<p>Formulées pour des usages variés, ces substances chimiques possèdent des propriétés spécifiques allant de la dissolution de matériaux à la génération de fumées ou de réactions catalytiques. Corrosives, combustibles ou réactives, elles sont utilisées dans des contextes aussi bien artisanaux que tactiques.</p>
<p><strong>Nature.</strong> Science.</p>
<p><strong>Création.</strong> Test combiné de travail organique (Artisanat) et Chimie (Science Organique).</p>
<p><strong>Usage.</strong> n/a.</p>
<p><strong>Effets.</strong> Permet la création de substances chimiques aux propriétés variées (dissoudre les matières, générer des fumées, etc.)</p>
<p><strong>Encombrement.</strong> ½ (par doses)</p>
<p><strong>Prix de base.</strong> selon les produits.</p>
</div>
</div>
...
<img src="images/image16.jpg" style="width:300px; margin-right:1em;">
<img src="images/image15.jpg" style="width:300px;">
