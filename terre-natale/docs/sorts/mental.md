...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Spiritualisation ✧</span> (Spiritus (Souffle) / Luspiri (Lu + spiri)) : Génère un enchantement positif qui augmente tous les attributs de l'esprit de <span style="color:#ff1493; font-weight:bold;">[Magnitude/7]</span> mais réduit ceux du corps d'autant. ***Clé :*** 🧩 Mental: Luspiriend

***Description :*** Augmente tous les attributs de l'esprit au détriment des attributs du corps.
...
***Notes :*** Affecte les PS (spiritualité).
...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Profanation ✸</span> (Profano (Souiller) / Kaprofan (Ka + profan)) : Produit un effet d'attaque mentale (résolution) infligeant <span style="color:#ff1493; font-weight:bold;">[Magnitude]</span> de dégats mentaux (PS) basés sur l'élément <span style="color:#ff1493; font-weight:bold;">[clé]</span>. ***Clé :*** 🧩 Mental: Kaprofanend

***Description :*** Inflige des dégâts mentaux directs via une attaque de résolution.
...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Traumatisation ✸</span> (Vulnus (Blessure) / Kavulnus (Ka + vulnus)) : Génère un effet infligeant un trauma de gravité <span style="color:#ff1493; font-weight:bold;">[Magnitude]</span>, la sauvegarde d'opposition modifie ce gain. ***Clé :*** 🧩 Mental: Kavulnusend

***Description :*** Inflige un trauma mental de gravité variable.
...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Suggestion ✸</span> (Gero (Porter) / Krusuger (Kru + suger)) : Produit un effet d'attaque mentale (résolution) infligeant <span style="color:#ff1493; font-weight:bold;">[Magnitude]</span> de dégats mentaux temporaires (PE puis PS) basés sur l'élément <span style="color:#ff1493; font-weight:bold;">[clé]</span>, le jet est assuré (minimum des dés 4) et majoré (+1 par dés). ***Clé :*** 🧩 Mental: Krusugerend
...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Amnésiation ✸</span> (Memoria (Mémoire) / Kinmemo (Kin + memo)) : Génère un effet qui supprime de la mémoire d'une cible un élément (personne, scène, objet ou lieu), le sort a un potenciel de <span style="color:#ff1493; font-weight:bold;">[Magnitude²]</span>, le temps auquel remonte la mémoire réduit d'autant le potenciel, chaque minutes nécessite 1 de potenciel, un test de détermination peux être effectué par la cible et si réussie le sort ne fonctionne pas. ***Clé :*** 🧩 Mental: Kinmemoend

***Description :*** Efface un souvenir ou élément précis de la mémoire de la cible.
...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Exsanguination ✸</span> (Sanguis (Sang) / Krasangui (Kra + sangui)) : Si la cible a moins de <span style="color:#ff1493; font-weight:bold;">[Magnitude]</span> PE elle perd tous ses PE et est mise en état de choc, elle peux réaliser un test de robustesse ou détermination (selon clé). ***Clé :*** 🧩 Mental: Krasanguiend

***Description :*** Vide tous les PE de la cible faible et la met en état de choc.

***Notes :*** La sauvegard est basée sur la détermination.
...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Corruption ✸</span> (Rumpo (Briser) / Korrupt (Kor + rupt)) : Génère un effet infligeant une condition de rupture (DOT), la cible peux réaliser un test de sauvegarde (qui dépend de la condition). ***Clé :*** 🧩 Mental: Korruptend

***Description :*** Inflige une condition de rupture mentale (DOT).
...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Harmonisation ⌖</span> (Harmonia (Harmonie) / Reharmo (Re + harmo)) : Produit un soin de <span style="color:#ff1493; font-weight:bold;">[Magnitude/2]</span> visant un trauma (lésion mentale), génère la moitié en fatigue. ***Clé :*** 🧩 Mental: Reharmoend

***Description :*** Soigne un trauma mental existant.
...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Absorption ✧</span> (Sorbeo (Boire) / Lemsorb (Lem + sorb)) : Génère un enchantement positif qui réduit de moitié les dégats d'un type (selon la <span style="color:#ff1493; font-weight:bold;">[clé]</span> utilisée) avec un maximum de <span style="color:#ff1493; font-weight:bold;">[Magnitude/2]</span>. ***Clé :*** 🧩 Mental: Lemsorbend

***Description :*** Réduit de moitié les dégâts mentaux reçus.

***Notes :*** Affecte les dégats mentaux.

---

## Lecture des Pensées Immédiates
***Difficulté :*** 8, ***Drain :*** 8, ***Type de sort :*** Pouvoir, ***Domaine du sort :*** 🧩, ***École du sort :*** École de Bénédiction
**Mot de diffusion :** <span style="color:#228B22; font-weight:bold;">Soi</span> : Portée : Sans, Vecteur : Sans, Cible soi possible.
**Mot de propagation :** <span style="color:#228B22; font-weight:bold;">Unique</span> : Touche une cible unique.

> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Divination ✧</span> (Divinus (Divin) / Luvinus (Lu + vinus)) : Génère un enchantement positif qui permet de voir les intentions des autres, lorsque le personnage réalise un test contre une cible dont il peux lire les pensés cette dernière reçoit une pénalité à ses défenses passives de <span style="color:#ff1493; font-weight:bold;">[Magnitude/7]</span>, du fait que le lanceur de sort est en mesure de savoir un peu à l'avance ce que la cible fera, de plus la défense du lanceur de sort est augmenté d'autant contre cette cible. ***Clé :*** 🧩 Mental: Luvinusend

***Description :*** Permet de lire les intentions et améliore la défense contre la cible.
...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Introspection ⛊</span> (Intra (Dedans) / Borintra (Bor + intra)) : Génère un enchantement neutre de type barrière mentale pouvant absorber jusqu'à <span style="color:#ff1493; font-weight:bold;">[Magnitude]</span> (minoré) les jets (dégats, impacts, charges) mentaux (attention car les barrières s'appliquent avant la réduction de dégats et autre ressors défensif des cibles). ***Clé :*** 🧩 Mental: Borintraend

***Description :*** Crée une barrière mentale qui absorbe les jets mentaux.
...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Connexion ⧉</span> (Necto (Lier) / Elonect (Elo + nect)) : Génère un effet qui permet au lanceur de sort de s'entretenir avec une cible par télépathie, pour un maximum de <span style="color:#ff1493; font-weight:bold;">[Magnitude]</span> mots minus la distance entre les deux protagonistes. ***Clé :*** 🧩 Mental: Elonectend

***Description :*** Permet la télépathie avec une cible pour un nombre limité de mots.
...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Retranscription ⧉</span> (Scribo (Écrire) / Erutran (Eru + tran)) : Génère un message envoyé à une cible à portée, le message est limité à <span style="color:#ff1493; font-weight:bold;">[Magnitude/2]</span> mots. ***Clé :*** 🧩 Mental: Erutranend

***Description :*** Envoie un court message mental à une cible.
...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Entrave ⧗</span> (Impedio (Empêcher) / Cariped (Car + iped)) : Génère un enchantement qui permet au lanceur de sort de empêcher sa cible d'agir, pour le prix d'une action libre le lanceur du sort peux ainsi empêcher sa cible de réaliser une action d'un type choisit, cependant si la cible réussis un test de sauvegarde (vs Détermination) elle échappe à ce contrôle (même si cela ne met pas fin à l'enchantement lui même), l'enchantement prend fin après que la cible s'est vue bannir d'un total de <span style="color:#ff1493; font-weight:bold;">[Magnitude/3]</span> actions. ***Clé :*** 🧩 Mental: Caripedyend

***Description :*** Empêche temporairement la cible d'effectuer un type d'action.

---

## Contrôle Magique
***Difficulté :*** 14, ***Drain :*** 14, ***Type de sort :*** Pouvoir, ***Domaine du sort :*** 🧩, ***École du sort :*** École de Conjuration
**Mot de diffusion :** <span style="color:#228B22; font-weight:bold;">Manifestation</span> : Portée : Portée magique x1, Vecteur : Vue, Cible soi possible.
**Mot de propagation :** <span style="color:#228B22; font-weight:bold;">Unique</span> : Touche une cible unique.

> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Marionnettisation ⧗</span> (Pupus (Poupée) / Conpupa (Con + pupa)) : Génère un enchantement qui permet au lanceur de sort de contrôler partiellement les faits et geste d'une cible, pour le prix d'une action libre le lanceur du sort peux ainsi forcer sa cible à réaliser une action, dés que c'est à elle d'agir celle ci tentera de réaliser l'action en question en premier lieu, cependant si la cible réussis un test de sauvegarde (vs Détermination) elle échappe à ce contrôle (même si cela ne met pas fin à l'enchantement lui même), l'enchantement prend fin après que la cible est réalisée ou refusée <span style="color:#ff1493; font-weight:bold;">[Magnitude/4]</span> actions forcées. ***Clé :*** 🧩 Mental: Conpupaend

***Description :*** Contrôle partiellement les actions de la cible.

---

## Domination Totale
***Difficulté :*** 16+X, ***Drain :*** 16+X, ***Type de sort :*** Pouvoir, ***Domaine du sort :*** 🧩, ***École du sort :*** École de Conjuration
**Mot de diffusion :** <span style="color:#228B22; font-weight:bold;">Manifestation</span> : Portée : Portée magique x1, Vecteur : Vue, Cible soi possible.
**Mot de propagation :** <span style="color:#228B22; font-weight:bold;">Unique</span> : Touche une cible unique.
...
***Description :*** Applique une condition de Furie.

***Notes :*** Condition : Furie.
...
***Description :*** Applique une condition de Confusion.

***Notes :*** Condition : Confusion.

---

## Voile de Morphée
***Difficulté :*** 16, ***Drain :*** 18, ***Type de sort :*** Pouvoir, ***Domaine du sort :*** 🧩, ***École du sort :*** École d'Altération
**Mot de diffusion :** <span style="color:#228B22; font-weight:bold;">Manifestation</span> : Portée : Portée magique x1, Vecteur : Vue, Cible soi possible.
...
***Description :*** Applique une condition de Sommeil en zone large.

***Notes :*** Condition : Sommeil.

---

## Don d'Excelsior
***Difficulté :*** 14+X, ***Drain :*** 14+X, ***Type de sort :*** Pouvoir, ***Domaine du sort :*** 🧩🧩, ***École du sort :*** École d'Altération
**Mot de diffusion :** <span style="color:#228B22; font-weight:bold;">Manifestation</span> : Portée : Portée magique x1, Vecteur : Vue, Cible soi possible.
**Mot de propagation :** <span style="color:#228B22; font-weight:bold;">Unique</span> : Touche une cible unique.
...
***Notes :*** Conditions : Assurance & Excellence.
