...
***Difficulté :*** 2, ***Drain :*** 2
**Clés :** ⚜️ Charme: Belcassoynh
Génère un effet qui annule l'action à venir de la cible cette dernière a moins de <span style="color:#ff1493; font-weight:bold;">[Magnitude]</span> en endurance actuelle, un test de sauvegarde de détermination peux permettre de réduire les effets, l'action entreprise est perdue si annulée.

---

#### 45. Rétroaction ['Abju'!C13]
***École :*** École d'Abjuration
***Latin :*** Ago (Agir), ***Arcanique :*** Basago (Bas + ago)
***Type de mot :*** Interruption, ***Type de cible :*** Cible
***Difficulté :*** 4, ***Drain :*** 4
**Clés :** ⚜️ Charme: Basagoynh
Génère un effet qui retourne l'action à venir de la cible contre elle même à moins qu'elle ne dispose de <span style="color:#ff1493; font-weight:bold;">[Magnitude/2]</span> en endurance actuelle, un test de sauvegarde de détermination peux permettre de réduire les effets.

---

#### 46. Obstruction ['Abju'!C29]
***École :*** École d'Abjuration
...
#### 49. Dissuasion ['Abju'!C39]
***École :*** École d'Abjuration
***Latin :*** Suadeo (Conseiller), ***Arcanique :*** Barvias (Bar + vias)
***Type de mot :*** Interruption, ***Type de cible :*** Cible
***Difficulté :*** 2, ***Drain :*** 2
**Clés :** ⚜️ Charme: Barviasynh
Génère un effet qui augmente la difficulté d'une action qui vise le lanceur de sort de <span style="color:#ff1493; font-weight:bold;">[Magnitude/4]</span>.

---

#### 50. Empathisation ['Divi'!C34]
