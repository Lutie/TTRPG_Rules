...
**Mot de propagation :** Cône [Forme] : Touche une cible, 3 cases de largeur et 2 cases de profondeur derrières elles (AOE spéciale).

**Mot de structure :** Vague [Forme] : Le sort, nécessairement en AOE, ne touche que les premières cibles d'une même lignes (en provenance de la cible d'origine de l'AOE), celles qui sont derrière ne sont pas affectée.
...
**Mot de propagation :** Rayon [Forme] : Touche une cible et jusqu'à 4 cases derrière celle ci (AOE spéciale).
...
**Mot de structure :** Double [Forme] : Le sort s'applique sur deux cibles distincts, ces deux cibles sont nécessaires.
*Modificateurs de Magnitude :* PWR -1
...
**Mot de structure :** Chaine [Forme] : Le sort s'applique puis change de cible, la nouvelle cible doit être valide, jusqu'à X fois en tout.
...
**Mot de liaison :** Ephémère [Liaison] : Le sort d'invocation ne dure qu'un cycle unique, l'invocation est avantagé a ses tests & jets.
