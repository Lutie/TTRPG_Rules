...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Perturbation</span> ['Conj'!C52] (Turbo (Troubler) / Centurb (Cen + turb)) : Génère un enchantement de lieu qui augmente la difficulté de sorts lancés dans la zone de <span style="color:#ff1493; font-weight:bold;">[Magnitude/5]</span>, la sauvegarde de détermination permettant de réduire cet effet. ***Clé :*** 🪷 Nature: Centurbeiln
