...
**Mot de liaison :** Combo [Liaison] : Le sort doit inclure deux mots, en duo ou avec une annexe : les deux mots doivent avoir un lien évident et explicite formant une combinaison logique; alors le sort reçoit PWR +1.

**Mot de liaison :** Perçant [Liaison] : L'attaque issus du sort génère des dégats perçants (ignore la moitié de l'absorption de la cible).

**Notes :** 2e mot Destruction, clé froid.