...
> **Mot de pouvoir :** <span style="color:#228B22; font-weight:bold;">Désenchantement</span> (Fallo (Tromper) / Brenfallo (Bren + fallo)) : Génère un effet qui provoque une décharge de <span style="color:#ff1493; font-weight:bold;">[Magnitude/2]</span> à tous les enchantements affectant la cible (lieu ou cible). ***Clé :*** 🪷 Nature
