...
**Mot de pouvoir :** Sublimification (Sublimis (Élevé) / Alsublim (Al + sublim)) [Pouvoir] : Produit un effet qui change l'état (gaz, liquide ou solide) de <span style="color:#ff1493; font-weight:bold;">[Magnitude x 2]</span> unités d'un élément qui dépends de la <span style="color:#ff1493; font-weight:bold;">[clé]</span>.
...
**Mot de pouvoir :** Fendaison (Findo (Fendre) / Aenfind (Aen + find)) [Pouvoir] : L'effet du sort génère une crevasse sur un sol de pierre, la largeur x longueur x profondeur doit être inférieure à <span style="color:#ff1493; font-weight:bold;">[Magnitude]</span>, aucun de ces paramètres ne peux pas être dépasser <span style="color:#ff1493; font-weight:bold;">[Magnitude/4]</span>, une cible peux réaliser un test de réflexe afin de réduire la distance de chute (en cas de réussite critique elle n'est simplement pas tombée et reste au bord), si la cible tombe elle doit réussir un test d'acrobatie ou escalade pour remonter.
...
**Mot de pouvoir :** Entravement (Vinculum (Lien) / Mugvin (Mug + vin)) [Pouvoir] : Génère un enchantement négatif qui réduit l'allure de la cible de <span style="color:#ff1493; font-weight:bold;">[Magnitude/4]</span>.
