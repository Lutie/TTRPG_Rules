...
**Mot de pouvoir :** Stalagmite *(mot introuvable dans les dictionnaires)*
...
**Mot de propagation :** Epieu [Forme] : Le projectile issus du sort traverse chaque cible qui se trouve sur son passage, chaque nouvelle cible subit des effets réduits (PWR -1).

---

## Oeil de Médusa

*Difficulté :* 20, *Drain :* 18
...
**Mot de pouvoir :** Entravement ['Malé'!C153] (Vinculum (Lien) / Mugvin (Mug + vin)) [Pouvoir] : Génère un enchantement négatif qui réduit l'allure de la cible de <span style="color:#ff1493; font-weight:bold;">[Magnitude/4]</span>.
...
**Mot de pouvoir :** Epiderme *(mot introuvable dans les dictionnaires)*
